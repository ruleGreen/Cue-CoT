...
if os.path.exists("./web_demo/config.json"):
    with open("./web_demo/config.json", "r", encoding='utf-8') as f:
        config = json.load(f)
else:
    config = {}

if os.path.exists("./web_demo/api_key.txt"):
...
if os.path.exists("./web_demo/auth.json"):
    ...
    with open("./web_demo/config.json", "w", encoding='utf-8') as f:
        json.dump(config, f, indent=4)
